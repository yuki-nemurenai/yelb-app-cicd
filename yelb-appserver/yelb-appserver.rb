...
configure :production do
  ...
  set :redisport => ENV['YELB_REDIS_PORT']
  set :redispassword => ENV['YELB_REDIS_PASSWORD']
  set :port, 4567
  set :yelbdbhost => "yelb-db"
  set :yelbdbport => 5432
  set :yelbdbname => "yelbdatabase"
  set :yelbdbuser => ENV['POSTGRES_USER']
  set :yelbdbpassword => ENV['POSTGRES_PASSWORD']
...
configure :custom do
  set :redishost => ENV['YELB_REDIS_ENDPOINT']
  set :redisport => ENV['YELB_REDIS_PORT']
  set :redispassword => ENV['YELB_REDIS_PASSWORD']
  set :port, 4567
